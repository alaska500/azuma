...
if __name__ == '__main__':
    ...
    while True:
        ...
        kzz_top_copy = kzz_top[
            ['债券代码', '债券名称', '涨跌幅', '最新价', '最高', '最低', '今开', '成交量', '成交额', '昨日收盘']]
        kzz_top_copy.insert(0, "时间", now)
        print(kzz_top_copy[:1].to_string())
        kzz_top_copy.to_csv(f"{today}.csv", mode='a', index=None, header=False)
        time.sleep(1)
